...
export function SelectServicesTypeContent({ staffId }) {
      ...
      try{
        const url =
          ...
          if (status === 200) {
            ...
            navigation.navigate('ShowServicesType', { staffId });
          } else if (status === 400) {
          ...
          <TouchableOpacity key={index} onPress={() => handleCheckboxClick(index)}>
            <View style={styles.checkBox}>
              ...
              <RoundedCheckbox
                ...
                outerStyle={{backgroundColor:"#000000" ,
                             width:20,
                             height:20,
                             alignItems:"center",
                             borderColor:"#000000"            
                }}
                innerStyle={{backgroundColor:"#FDFDFD",
                             width:17,
                             height:17,
                             alignItems:"center",
                }}
